      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0 rounded-3xl border-2 border-transparent" 
               style={{ 
                 background: 'linear-gradient(90deg, transparent, #8b5cf6, transparent) border-box',
        ...
        <div className="relative p-8 flex flex-col items-center">
          ...
          <div className="relative mb-6">
            <svg className="w-20 h-20 text-violet-500" viewBox="0 0 52 52">
              <circle 
          ...
          <h2 className="text-3xl font-bold bg-gradient-to-r from-violet-400 to-fuchsia-500 bg-clip-text text-transparent mb-2 text-center">{title}</h2>
          <p className="text-muted-foreground mb-6 text-center">{subtitle}</p>

          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-500/10 border border-violet-500/20 text-xs font-bold text-violet-400 mb-8">
          ...
          <div className="w-full space-y-3 mb-8 px-2">
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="text-violet-400 font-bold">Confirmed ✓</span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 w-full">
            <button 
              onClick={onClose}
              className="px-4 py-2 rounded-xl border border-white/10 hover:bg-white/5 transition-colors text-white text-sm font-medium"
            >
              Close
            </button>
            <button 
              ...
              className="px-4 py-2 rounded-xl flex items-center justify-center gap-2 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white text-sm font-bold border-none transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
