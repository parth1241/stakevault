...
export default function WalletStatusBar() {
  ...
  return (
    <div className="sticky top-0 z-40 w-full h-14 bg-[#0a0812]/80 backdrop-blur-md border-b border-violet-500/20 transition-all duration-300">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <div className="flex flex-col">
            <span className="text-[10px] uppercase font-black tracking-widest text-white leading-none mb-1">
              StakeVault Node Active
            </span>
            <span className="font-mono text-[11px] text-violet-400 font-bold leading-none">
        ...
        <div className="flex items-center gap-6">
          <div className="flex flex-col items-center">
             <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black text-violet-400 uppercase tracking-tighter">XLM</span>
                <button 
                  onClick={fetchWalletData}
                  disabled={loading}
                  className={cn(
                    "text-muted-foreground hover:text-violet-400 transition-colors ml-1",
                    loading && "animate-spin text-violet-400"
                  )}
                >
                  <RefreshCw size={14} />
                </button>
        ...
        <div className="flex items-center gap-3 shrink-0">
           <Dialog>
            <DialogTrigger asChild>
              <Button size="sm" className="bg-violet-600 hover:bg-violet-500 text-white h-9 px-4 font-black uppercase tracking-widest text-[10px] italic shadow-lg shadow-violet-500/20">
